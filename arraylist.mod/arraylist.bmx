...
Public
	...
	about: Throws #TIndexOutOfBoundsException if the index is out of range.
	End Rem
	...
	about: Throws #TIndexOutOfBoundsException if the index is out of range.
	End Rem
	Method Operator [] :T(index:Int) Override
		If index < 0 Or index >= size Then
			Throw New TIndexOutOfBoundsException
		End If
	...
	about: Throws #TIndexOutOfBoundsException if the index is out of range.
	End Rem
	Method Operator []= (index:Int, value:T) Override
		If index < 0 Or index >= size Then
			Throw New TIndexOutOfBoundsException
		End If
